...
class Api::V1::RoomTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_room_type" do
    assert_difference("Api::V1::RoomType.count") do
      post api_v1_room_types_url, params: { api_v1_room_type: { description: @api_v1_room_type.description, price: @api_v1_room_type.price, type: @api_v1_room_type.type } }, as: :json
    end
  ...
  test "should update api_v1_room_type" do
    patch api_v1_room_type_url(@api_v1_room_type), params: { api_v1_room_type: { description: @api_v1_room_type.description, price: @api_v1_room_type.price, type: @api_v1_room_type.type } }, as: :json
    assert_response :success
  end
